    ...
    >
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-gray-900 mb-2">Crea tu cuenta en NexDesk</h2>
          <p className="text-gray-600">Comienza a gestionar tu plataforma</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onChange={handleChange}
                placeholder="••••••••"
                className="pl-10 bg-white border-gray-200 text-gray-900 placeholder:text-gray-400 focus:border-[#3CA2A2] focus:ring-[#3CA2A2]"
                required
              />
            </div>
          </div>
